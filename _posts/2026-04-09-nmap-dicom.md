...
4. AAPM (2004) medical-physics report on DICOM connectivity at a clinical site, including the example of one CT host advertising distinct AETs per role (`ct5` Storage SCU and `PR-ct5_SCU` Print SCU). Citation link TBD.
