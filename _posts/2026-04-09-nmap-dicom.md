...
4. Shepard, S. J. (2004). *DICOM Basics for Radiographic and Fluoroscopic Systems.* 2004 AAPM Summer School, UT M.D. Anderson Cancer Center. The slide on Application Entity Titles gives the example: *"May have several for different service classes ('ct5' for Store, 'PR-ct5_SCU' for Print)."* [aapm.org/meetings/04ss/documents/DICOMBasics.pdf](https://www.aapm.org/meetings/04ss/documents/DICOMBasics.pdf).
