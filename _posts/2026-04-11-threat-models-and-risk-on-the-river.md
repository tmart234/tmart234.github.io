...
Here's how the same risk thinking mentality shows up in both domains.

## 1. Environmental Risks 🌊

Neither domain can avoid or abstain from risk entirely. Whitewater paddlers accept certain dangers the moment they get on the river, just as medical device security teams accept risk by going to market. In some medical devices you cannot avoid: being a networked device, being implanted in a body, using third-party software, or functioning within an operating room. The environment is the environment. You don't get to opt out of the parts you don't like.
...
After the paddler has a plan and has scouted, they need to execute it. When executing, they are actively reading the water in real-time to look for more unforeseen hazards (detection). These hazards might not have been visible during scouting -- a downed tree just below the surface, a recirculating hole that only appears at this flow, a strainer that formed since the last person ran it. You planned. You scouted. And you still need to keep your eyes open.
...
This is having a defense in depth strategy that emphasizes the Respond and Recover aspects of NIST's CSF. Cybersecurity uses multiple layers of controls and rehearsed incident response procedures for when primary defenses or threat models fail.
